...
# Paths
save_dir = 'plots/DirectionalMosW/I%d-%d-%d-Wgau%d-%d_Wmos%d-%d-%d_WCA3IN-%d-%d_WMOSIN-%d-%d'%(Ipos_max, Iangle_diff, I_noiseSD, wmax_adiff, w_akappa, wmax_mosmos, wmax_ca3mos, wmax_mosca3, wmax_CA3in, wmax_inCA3, wmax_Mosin, wmax_inMos)
# save_dir = 'plots/OnlyCA3_NoIn/Wgau%d-%d_IBa%0.3fd%0.2fc%dLTS_I%d-%d_Ustdx-%0.2f-%0.2f_WINCA3-%d-%d-%d_Wmos-%d-%d-%d_WINMOS-%d-%d'%(wmax_adiff, w_akappa, izhi_a_ex, izhi_d_ex, izhi_c_ex, Ipos_max, Iangle_diff, U_stdx_CA3, U_stdx_mos, wmax_CA3in, wmax_inCA3, wmax_inin, wmax_mosmos, wmax_ca3mos, wmax_mosca3, wmax_Mosin, wmax_inMos)
os.makedirs(save_dir, exist_ok=True)
# Parameter Scan
# Ipos_maxs = np.arange(0.5, 5.5, 0.5)
# for Ipos_max in Ipos_maxs:
#     Iangle_diff = Ipos_max * 2
for wmax_ca3ca3 in [0]:
    mos_corr_dict = dict()
