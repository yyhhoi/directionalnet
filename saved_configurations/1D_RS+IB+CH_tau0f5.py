...
def params_search(Ipos_max, Iangle_diff, wmax_ca3ca3, wsd_ca3ca3, save_pth):
    ...
    # izhi_a, izhi_b, izhi_c, izhi_d = 0.02, 0.2, -65, 8  # Regular spiking
    ...
    # Ipos_max = 30  # CH: 10, IB: 20, RS: 24
    # Iangle_diff = 15  # CH: 20, IB: 40, RS: 26
    Ipos_sd = 1
    ...
    fig, ax = plt.subplots(6, 5, figsize=(14, 10), facecolor='white', constrained_layout=True)
...
save_dir = 'plots/Tau0f5_CH+RS+IB'
os.makedirs(save_dir, exist_ok=True)

Ipos_max = 20
Iangle_diff = 40
w = 5
save_pth = join(save_dir, 'IB.png')
print('start processing %s'%(save_pth))
params_search(Ipos_max, Iangle_diff, w, 2, save_pth)
