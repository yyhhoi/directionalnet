...
from library.comput_utils import cal_hd_np, pair_diff, gaufunc2d, gaufunc2d_angles, circgaufunc, boxfunc2d, get_tspdiff, \
    calc_exin_samepath
...
# Paths
I_txt = 'I%d-%d-%d'%(Ipos_max, Iangle_diff, I_noiseSD)
ca3_tun_txt = 'Wca3Adiff-%d-%d_Wca3In-%d-%d_Wca3-%d'%(wmax_ca3ca3_adiff, w_ca3ca3_akappa, wmax_CA3in, wmax_inCA3, wmax_ca3ca3)
mos_tun_txt = 'WmosAdiff-%d-%d_WmosIn-%d-%d_Wmos-%d-%d-%d_ProjL%d' %(wmax_ca3mosca3_adiff, w_ca3mosca3_akappa, wmax_Mosin, wmax_inMos, wmax_mosmos, wmax_ca3mos, wmax_mosca3, projl_MosCA3)
save_dir = 'plots/DirectionalMosW_MosN40/%s_%s_%s'%(I_txt, ca3_tun_txt, mos_tun_txt)
