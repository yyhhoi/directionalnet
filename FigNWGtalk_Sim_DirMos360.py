...
save_dir = join('sim_results', 'FigNWGtalk')
os.makedirs(save_dir, exist_ok=True)
for mosdeg in np.arange(0, 360, 45):
    save_pth = join(save_dir, 'FigNWGtalk_MossyLayer_Mosdeg%d.pkl'%(mosdeg))
    print(save_pth)
